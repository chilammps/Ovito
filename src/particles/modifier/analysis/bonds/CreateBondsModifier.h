 ...
 * \brief Contains the definition of the Particles::CreateBondsModifier class.
 */
...
#include <core/Core.h>
#include <particles/data/BondsDisplay.h>
...
Q_DECLARE_METATYPE(Particles::CreateBondsModifier::CutoffMode);
Q_DECLARE_TYPEINFO(Particles::CreateBondsModifier::CutoffMode, Q_PRIMITIVE_TYPE);
