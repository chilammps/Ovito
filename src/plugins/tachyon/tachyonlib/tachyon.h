 ...
 *   rendering engine.                                            
 *
 * $Id: tachyon.h,v 1.120 2011/02/18 04:52:15 johns Exp $
 *
 */
 ...
 * floating point types, based on compile-time definition of the
 * USESINGLEFLT macro.
 */
#ifdef USESINGLEFLT
#error "DO NOT USE SINGLE PRECISION FLOATIN POINT FOR TACHYON"
