...
Q_DECLARE_METATYPE(Ovito::Plugins::Particles::Import::Lammps::LAMMPSDataImporter::LAMMPSAtomStyle);
Q_DECLARE_TYPEINFO(Ovito::Plugins::Particles::Import::Lammps::LAMMPSDataImporter::LAMMPSAtomStyle, Q_PRIMITIVE_TYPE);
