...
#ifndef __OVITO_PYSCRIPT_SCRIPT_BINDING_H
#define __OVITO_PYSCRIPT_SCRIPT_BINDING_H
...
/**
 * \brief Abstract base class for Python script bindings of OVITO plugins.
 *
 * Plugins that would like to make their functions and classes available to Python scripts should
 ...
 */
class OVITO_PYSCRIPT_EXPORT ScriptBinding : public OvitoObject
{
public:
