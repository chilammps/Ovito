...
BOOST_PYTHON_MODULE(PyScriptLinearAlgebra)
{
	...
	class_<Vector2>("Vector2", init<FloatType, FloatType>())
		.def(init<FloatType>())
		.def("__init__", make_constructor((Vector2* (*)())([]() { return new Vector2(Vector2::Zero()); })))
		.add_property("x", (FloatType (Vector2::*)() const)&Vector2::x, (void (*)(Vector2&,FloatType))([](Vector2& v, FloatType x) { v.x() = x; }))
		.add_property("y", (FloatType (Vector2::*)() const)&Vector2::y, (void (*)(Vector2&,FloatType))([](Vector2& v, FloatType y) { v.y() = y; }))
	...
	class_<Vector4>("Vector4", init<FloatType, FloatType, FloatType, FloatType>())
		.def(init<FloatType>())
		.def("__init__", make_constructor((Vector4* (*)())([]() { return new Vector4(Vector4::Zero()); })))
		.add_property("x", (FloatType (Vector4::*)() const)&Vector4::x, (void (*)(Vector4&,FloatType))([](Vector4& v, FloatType x) { v.x() = x; }))
		.add_property("y", (FloatType (Vector4::*)() const)&Vector4::y, (void (*)(Vector4&,FloatType))([](Vector4& v, FloatType y) { v.y() = y; }))
		.add_property("z", (FloatType (Vector4::*)() const)&Vector4::z, (void (*)(Vector4&,FloatType))([](Vector4& v, FloatType z) { v.z() = z; }))
		.add_property("w", (FloatType (Vector4::*)() const)&Vector4::w, (void (*)(Vector4&,FloatType))([](Vector4& v, FloatType w) { v.w() = w; }))
	...
	class_<Point2>("Point2", init<FloatType, FloatType>())
		.def(init<FloatType>())
		.def("__init__", make_constructor((Point2* (*)())([]() { return new Point2(Point2::Origin()); })))
		.add_property("x", (FloatType (Point2::*)() const)&Point2::x, (void (*)(Point2&,FloatType))([](Point2& p, FloatType x) { p.x() = x; }))
		.add_property("y", (FloatType (Point2::*)() const)&Point2::y, (void (*)(Point2&,FloatType))([](Point2& p, FloatType y) { p.y() = y; }))
		.def(self + other<Vector2>())
	...
	class_<Quaternion>("Quaternion", init<FloatType, FloatType, FloatType, FloatType>())
		...
		.def("__init__", make_constructor((Quaternion* (*)())([]() { return new Quaternion(Quaternion::Identity()); })))
		.add_property("x", (FloatType (Quaternion::*)() const)&Quaternion::x, (void (*)(Quaternion&,FloatType))([](Quaternion& q, FloatType x) { q.x() = x; }))
		.add_property("y", (FloatType (Quaternion::*)() const)&Quaternion::y, (void (*)(Quaternion&,FloatType))([](Quaternion& q, FloatType y) { q.y() = y; }))
		.add_property("z", (FloatType (Quaternion::*)() const)&Quaternion::z, (void (*)(Quaternion&,FloatType))([](Quaternion& q, FloatType z) { q.z() = z; }))
		.add_property("w", (FloatType (Quaternion::*)() const)&Quaternion::w, (void (*)(Quaternion&,FloatType))([](Quaternion& q, FloatType w) { q.w() = w; }))
	...
	class_<Rotation>("Rotation", init<const Vector3&, FloatType, optional<bool>>())
		...
		.def("__init__", make_constructor((Rotation* (*)())([]() { return new Rotation(Rotation::Identity()); })))
	...
	class_<Scaling>("Scaling", init<const Vector3&, const Quaternion&>())
		.def("__init__", make_constructor((Scaling* (*)())([]() { return new Scaling(Scaling::Identity()); })))
	...
	class_<Matrix3>("Matrix3", init<FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType>())
		...
		.def("__init__", make_constructor((Matrix3* (*)())([]() { return new Matrix3(Matrix3::Identity()); })))
		...
		.def("get", (FloatType (*)(const Matrix3&, int, int))([](const Matrix3& m, int row, int col) { return m(row,col); }))
		.def("set", (void (*)(Matrix3&, int, int, FloatType))([](Matrix3& m, int row, int col, FloatType v) { m(row,col) = v; }))
	...
	class_<AffineTransformation>("AffineTransformation", init<FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType>())
		...
		.def("__init__", make_constructor((AffineTransformation* (*)())([]() { return new AffineTransformation(AffineTransformation::Identity()); })))
		...
		.def("get", (FloatType (*)(const AffineTransformation&, int, int))([](const AffineTransformation& m, int row, int col) { return m(row,col); }))
		.def("set", (void (*)(AffineTransformation&, int, int, FloatType))([](AffineTransformation& m, int row, int col, FloatType v) { m(row,col) = v; }))
		.def(self * other<AffineTransformation>())
		.def(self * other<Matrix3>())
		.def(self * other<Point3>())
		.def(self * other<Vector3>())
