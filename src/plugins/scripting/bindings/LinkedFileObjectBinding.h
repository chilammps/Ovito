...
#ifndef __OVITO_SCRIPTING_LINKED_FILE_OBJECT_BINDING_H
#define __OVITO_SCRIPTING_LINKED_FILE_OBJECT_BINDING_H
 ...
 */
class LinkedFileObjectBinding : public ScriptBinding, public QScriptable
{
public:

	/// \brief Default constructor.
	Q_INVOKABLE LinkedFileObjectBinding() {}
