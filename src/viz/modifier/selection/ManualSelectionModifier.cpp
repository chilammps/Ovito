...
IMPLEMENT_SERIALIZABLE_OVITO_OBJECT(Viz, ManualSelectionModifier, ParticleModifier)
IMPLEMENT_OVITO_OBJECT(Viz, ManualSelectionModifierEditor, ParticleModifierEditor)
...
{
	QWidget* rollout = createRollout(tr("Manual particle selection"), rolloutParams);
