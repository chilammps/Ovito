 ...
 * \brief Contains the definition of the Viz::CentroSymmetryModifier class.
 */
...
protected:
	...
	virtual bool hasValidModifierResults() override { return cspValues().size() == inputParticleCount(); }
