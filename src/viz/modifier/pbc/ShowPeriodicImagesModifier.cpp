...
IMPLEMENT_SERIALIZABLE_OVITO_OBJECT(Viz, ShowPeriodicImagesModifier, ParticleModifier)
IMPLEMENT_OVITO_OBJECT(Viz, ShowPeriodicImagesModifierEditor, ParticleModifierEditor)
