...
#include <viz/importer/AtomsImporter.h>
...
public:
	...
	InputColumnReader(const InputColumnMapping& mapping, AtomsImporter::AtomsData& destination, size_t particleCount);
...
private:
	...
	/// The data container.
	AtomsImporter::AtomsData _destination;
