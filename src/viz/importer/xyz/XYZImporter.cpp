...
#include <viz/importer/InputColumnMappingDialog.h>
#include "XYZImporter.h"

namespace Viz {

IMPLEMENT_SERIALIZABLE_OVITO_OBJECT(Viz, XYZImporter, ParticleImporter)
IMPLEMENT_OVITO_OBJECT(Viz, XYZImporterEditor, PropertiesEditor)
