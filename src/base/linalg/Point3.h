...
/**
 * \file Point3.h
 * \brief Contains definition of the Ovito::Point_3 template class and operators.
 */
...
public:
	...
	constexpr bool equals(const Point_3& p, T tolerance = T(FLOATTYPE_EPSILON)) const {
