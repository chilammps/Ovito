...
/**
 * \file
 * \brief Contains the definition of the Ovito::Math::Vector_3 class template.
 */
...
Q_DECLARE_METATYPE(Ovito::Math::Vector3);
Q_DECLARE_METATYPE(Ovito::Math::Vector3I);
Q_DECLARE_METATYPE(Ovito::Math::Vector3*);
Q_DECLARE_METATYPE(Ovito::Math::Vector3I*);
Q_DECLARE_TYPEINFO(Ovito::Math::Vector3, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(Ovito::Math::Vector3I, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(Ovito::Math::Vector3*, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(Ovito::Math::Vector3I*, Q_PRIMITIVE_TYPE);
