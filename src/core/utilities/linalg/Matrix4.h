...
/** 
 * \file
 * \brief Contains the definition of the Ovito::Math::Matrix_4 class template.
 */
...
public:
	...
	explicit Q_DECL_CONSTEXPR Matrix_4(const AffineTransformationT<T>& tm) : _m{
...
Q_DECLARE_METATYPE(Ovito::Math::Matrix4);
Q_DECLARE_METATYPE(Ovito::Math::Matrix4*);
Q_DECLARE_TYPEINFO(Ovito::Math::Matrix4, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(Ovito::Math::Matrix4*, Q_PRIMITIVE_TYPE);
