...
/**
 * \file
 * \brief Contains the definition of the Ovito::Math::Vector_4 class template.
 */
...
Q_DECLARE_METATYPE(Ovito::Math::Vector4);
Q_DECLARE_METATYPE(Ovito::Math::Vector4I);
Q_DECLARE_METATYPE(Ovito::Math::Vector4*);
Q_DECLARE_METATYPE(Ovito::Math::Vector4I*);
Q_DECLARE_TYPEINFO(Ovito::Math::Vector4, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(Ovito::Math::Vector4I, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(Ovito::Math::Vector4*, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(Ovito::Math::Vector4I*, Q_PRIMITIVE_TYPE);
