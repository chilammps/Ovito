...
public:
	...
	enum Type {
		...
		/// This event is generated by a SelectionSet when a SceneNode in the selection set has changed.
		NodeInSelectionSetChanged,

		/// This event is generated by a GroupNode if it has been opened or closed.
		GroupNodeOpenedOrClosed,
		...
		/// This event is generated by an object (e.g. a modifier) when its status has changed.
		StatusChanged,

		/// This event is sent by an object or modifier in the modification pipeline if pending
		/// results have become available.
		PendingOperationSucceeded,

		/// This event is sent by an object or modifier in the modification pipeline if pending
		/// results will not become available because the operation has been canceled by the user
		/// or because an error has occurred.
		PendingOperationFailed,
	};
