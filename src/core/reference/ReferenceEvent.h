...
public:
	...
	enum Type {
		...
		/// This event is generated by a selection set when a node in the selection set has changed.
		NodeInSelectionSetChanged,

		/// This event is generated by a group node if it has been opened or closed.
