...
/**
 * \file DefaultLineGeometryBuffer.h
 * \brief Contains the definition of the Ovito::DefaultLineGeometryBuffer class.
 */
 ...
 */
class OVITO_CORE_EXPORT DefaultLineGeometryBuffer : public LineGeometryBuffer
{
public:
