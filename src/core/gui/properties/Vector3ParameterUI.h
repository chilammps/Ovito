...
public:
	...
	Vector3ParameterUI(QObject* parentEditor, const char* propertyName, size_t vectorComponent, const QString& labelText = QString(), ParameterUnit* parameterUnit = nullptr);
