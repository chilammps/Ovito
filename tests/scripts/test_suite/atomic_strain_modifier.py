...
print "  assume_unwrapped_coordinates:", modifier.assume_unwrapped_coordinates
...
print "  output_deformation_gradients:", modifier.output_deformation_gradients
modifier.output_deformation_gradients = True

print "  output_nonaffine_squared_displacements:", modifier.output_nonaffine_squared_displacements
modifier.output_nonaffine_squared_displacements = True

print "  output_strain_tensors:", modifier.output_strain_tensors
modifier.output_strain_tensors = True

print "  reference_frame:", modifier.reference_frame
modifier.reference_frame = 0

print "  select_invalid_particles:", modifier.select_invalid_particles
...
print "Output:"
print "  invalid_particle_count=", modifier.invalid_particle_count
